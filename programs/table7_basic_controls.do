...
outreg2 using tables/table_7a_control, coefastr se adds("Parm p",`pvalparm',"Nonparm p",`pvalnonparm') replace title("tables/table 7a")
...
local pvalnonparm = r(p_exact)
outreg2 using tables/table_7a_control, coefastr se adds("Parm p",`pvalparm',"Nonparm p",`pvalnonparm') append 
...
outreg2 using tables/table_7b_control, coefastr se adds("Intense war-Parm p",`pvalparmA',"Intense war-Nonparm p",`pvalnonparmA',"No war-Parm p",`pvalparmN',"No war-Nonparm p",`pvalnonparmN') replace
...
local pvalnonparmN = r(p_exact)
outreg2 using tables/table_7b_control, coefastr se adds("Intense war-Parm p",`pvalparmA',"Intense war-Nonparm p",`pvalnonparmA',"No war-Parm p",`pvalparmN',"No war-Nonparm p",`pvalnonparmN') append
...
local pvalnonparmN = r(p_exact)
outreg2 using tables/table_7b_control, coefastr se adds("Intense war-Parm p",`pvalparmA',"Intense war-Nonparm p",`pvalnonparmA',"Moderate war-Parm p",`pvalparmS',"Moderate war-Nonparm p",`pvalnonparmS',"No war-Parm p",`pvalparmN',"No war-Nonparm p",`pvalnonparmN') append 
