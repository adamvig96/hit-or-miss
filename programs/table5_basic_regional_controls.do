...
outreg2 using "tables/table_5a_control_regional.tex", coefastr se adds("Parm p",`pvalparm',"Nonparm p",`pvalnonparm') replace title("Table 5")

reg npolity2dummy11 success `controlvars' `regionalcontrols' `fixedeffectvars' if seriousattempt == 1  , cluster(cowcode)
testparm success
local pvalparm = r(p)
tab npolity2dummy11 success if seriousattempt == 1, exact chi2
local pvalnonparm = r(p_exact)
outreg2 using "tables/table_5a_control_regional.tex", coefastr se adds("Parm p",`pvalparm',"Nonparm p",`pvalnonparm') append 

reg perexitregularNC201 success `controlvars' `regionalcontrols' `fixedeffectvars' if seriousattempt == 1  , cluster(cowcode)
testparm success
local pvalparm = r(p)
...
reg npolity2dummy11   successlautoc successldemoc lautoc `controlvars' `regionalcontrols' `fixedeffectvars' if seriousattempt == 1  , cluster(cowcode)
...
outreg2 using "tables/table_5b_control_regional.tex", coefastr se adds("Autoc-Parm p",`pvalparmA',"Autoc-Nonparm p",`pvalnonparmA',"Democ-Parm p",`pvalparmD',"Democ-Nonparm p",`pvalnonparmD') replace title("Table 5b")


reg perexitregularNC201 successlautoc successldemoc lautoc `controlvars' `regionalcontrols' `fixedeffectvars' if seriousattempt == 1  , cluster(cowcode)
testparm successlautoc 
local pvalparmA = r(p)
testparm successldemoc
local pvalparmD = r(p)
...
outreg2 using "tables/table_5b_control_regional.tex",  coefastr se adds("Autoc-Parm p",`pvalparmA',"Autoc-Nonparm p",`pvalnonparmA',"Democ-Parm p",`pvalparmD',"Democ-Nonparm p",`pvalnonparmD') append 
